class Block512() {
    ...
    def makeHash(hash: List[Word32]): List[Word32] = {
        ...
        var a: Word32 = new Word32(hash.head)
        var b: Word32 = new Word32(hash(1))
        var c: Word32 = new Word32(hash(2))
        var d: Word32 = new Word32(hash(3))
        var e: Word32 = new Word32(hash(4))
        var f: Word32 = new Word32(hash(5))
        var g: Word32 = new Word32(hash(6))
        var h: Word32 = new Word32(hash.last)
        var S0: Word32 = new Word32()
        var S1: Word32 = new Word32()
        var ch: Word32 = new Word32()
        var maj: Word32 = new Word32()
        var temp1: Word32 = new Word32()
        var temp2: Word32 = new Word32()
        for (i <- 0 to 63) {
